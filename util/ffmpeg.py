...
def image2video(fps,imagepath,voicepath,videopath):
    os.system('ffmpeg -y -r '+str(fps)+' -i '+imagepath+' -c:v hevc_nvenc -pix_fmt p010le -preset slow -rc vbr -cq 20 -b:v 0 '+os.path.split(voicepath)[0]+'/video_tmp.mp4')
